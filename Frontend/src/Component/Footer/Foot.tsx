...
export default function Foot() {
  return (
    <footer className="p-4 bg-white md:p-8 lg:p-10 bottom-0 dark:bg-gray-900 mt-auto">
      <div className="mx-auto max-w-screen-xl text-center">
        ...
        {/* Description */}
        <p className="my-6 text-gray-500 dark:text-gray-900">
        ...
        <span className="text-sm text-gray-900 sm:text-center dark:text-gray-900">
          © 2025 <Link to="/home" className="hover:underline">Aurleaf™</Link>. All Rights Reserved.
        </span>
      </div>
    </footer>
  );
