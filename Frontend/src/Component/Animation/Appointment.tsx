...
const Appointment = () => {
  ...
  const doctors = [
    {
      ...
      image: image3,
      description:
        'Certified Ayurvedic practitioner with 20+ years of experience in holistic healing and natural therapies.',
    ...
    },
    {
      ...
      image: image1,
      description:
        'Expert in Panchakarma therapy and Ayurvedic diet planning for chronic diseases.',
    ...
    },
    {
      ...
      image: image2,
      description:
        'Specialist in Ayurvedic treatments for skin disorders and natural wellness therapies.',
  ...
  return (
    <div className="w-full flex justify-center items-center py-16 bg-gradient-to-br from-amber-100 via-amber-100 to-amber-100 overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row w-full gap-6">
          ...
          <div className="w-full md:w-1/2 flex flex-col justify-between">
            <div>
              ...
              <div className="mb-3">{renderStars(doctor.rating)}</div>
              <div className="flex items-start mb-4">
                <svg
                  className="w-4 h-4 text-amber-400 mt-1 mr-1"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
